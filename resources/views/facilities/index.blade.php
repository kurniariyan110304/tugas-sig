                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <i
                                                class="fas fa-{{ $facility->type == 'sekolah' ? 'school' : ($facility->type == 'rumah_sakit' ? 'hospital' : ($facility->type == 'puskesmas' ? 'clinic-medical' : ($facility->type == 'tempat_ibadah' ? 'place-of-worship' : ($facility->type == 'pasar' ? 'shopping-cart' : 'map-marker')))) }} me-2 text-muted"></i>
                                    ...
                                    <td>
                                        <div class="text-muted small">
                                            <div><i class="fas fa-arrow-up me-1"></i>
                                                {{ number_format($facility->latitude, 6) }}</div>
                                            <div><i class="fas fa-arrow-right me-1"></i>
                                                {{ number_format($facility->longitude, 6) }}</div>
                                        </div>
                                    </td>
                                    <td>
                        ...
                        <div class="row">
                            @foreach ($facilityTypes as $key => $label)
                                @php
                                    ...
                                    $percentage =
                                        $facilities->count() > 0 ? round(($count / $facilities->count()) * 100) : 0;
                                @endphp
                                @if ($count > 0)
